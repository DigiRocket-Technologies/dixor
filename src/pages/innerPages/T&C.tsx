    ...
    <>
      ...
      <LayoutV1>
        ...
        <div style={{ padding: "50px 20px" }} className="container">
          ...
          <p>
            By accessing or using our website (https://digirocket.io), you agree
          ...
          <p>
            ...
            designs, and other materials, is the property of DigiRocket
          ...
          <p>
            DigiRocket Technologies will not be held liable for any direct,
