...
const Shopify = () => {
    ...
    return (
        <>
            ...
            <LayoutV1>
                <Breadcrumb title='Shopify Development' breadCrumb='Shopify Development' LightMode={false} />
                {data && <ShopifyContent serviceInfo={data} pricing={pricing} sectionClass='default-padding' />}
                <DarkClass/>
            </LayoutV1>
        </>
    );
