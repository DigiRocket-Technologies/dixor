  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover how Digirocket Technologies helped Gourmet Kitchen Works improve online presence, branding, and digital performance with a tailored marketing strategy."></meta>
      </Helmet>
